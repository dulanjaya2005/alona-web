...
import { Code2, Smartphone, Palette, Cloud, Globe, Zap, ArrowRight, CheckCircle, Monitor, ShoppingCart } from 'lucide-react';
import Layout from '../components/Layout';

// ✅ ඔබේ services මෙතන edit කරන්න
const SERVICES = [
  {
    id         : 1,
    title      : 'Web Development',
    description: 'We build modern, fast, and responsive websites tailored to your business needs. From landing pages to full-scale web applications.',
    icon       : Globe,
  },
  {
    id         : 2,
    title      : 'Software Development',
    description: 'Custom software solutions designed to streamline your business operations, increase productivity, and drive growth.',
    icon       : Code2,
  },
  {
    id         : 3,
    title      : 'POS System Development',
    description: 'Point of Sale systems built for retail, restaurants, and businesses. Fast, reliable, and easy to use with real-time reporting.',
    icon       : ShoppingCart,
  },
  {
    id         : 4,
    title      : 'UI/UX Design',
    description: 'Beautiful, user-centered designs that convert visitors into customers. We create intuitive interfaces that users love.',
    icon       : Palette,
  },
  {
    id         : 5,
    title      : 'System Development',
    description: 'End-to-end system architecture and development. We design and build scalable, secure, and maintainable systems for your business.',
    icon       : Monitor,
  },
];
...
const TECH_STACK = [
  ...
  'AWS', 'Docker', 'PostgreSQL', 'MySQL',
];

// ✅ Stats — ඔබේ values දාන්න
const STATS = [
...
export default function Services() {
  return (
    <>
      <SEOHead
        title="Services"
        description="Web development, software development, POS systems, UI/UX design and more."
        path="/services"
      />
      ...
      <section className="relative pt-32 pb-20 overflow-hidden grid-bg">
        ...
        <div className="px-6 mx-auto max-w-7xl">
          <motion.div initial="hidden" animate="visible">
            ...
            >
              Full-spectrum digital services — from pixel-perfect UIs to scalable software systems.
            </motion.p>
          </motion.div>
        </div>
      </section>
            ...
            {SERVICES.map((service, i) => {
              ...
              return (
                ...
                >
                  {/* Icon */}
                  <div
                    className="flex items-center justify-center w-12 h-12 mb-6 transition-all duration-300 group-hover:scale-110"
                    style={{
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {TECH_STACK.map((tech, i) => (
              <motion.div
                ...
                className="px-4 py-2 text-sm cursor-default glass"
      ...
      <section className="section" style={{ background: 'var(--bg2)' }}>
        <div className="px-6 mx-auto max-w-7xl">
          <div className="grid items-center grid-cols-1 gap-16 lg:grid-cols-2">
            ...
            >
              <div className="mb-6 badge">Why Us</div>
              <h2 className="mb-8 text-4xl font-black" style={{ fontFamily: 'var(--font-display)' }}>
                The <span className="grad-text">Advantage</span>
              </h2>
            ...
            >
              <div className="mb-2 text-6xl font-black" style={{ fontFamily: 'var(--font-display)', color: 'var(--acid)' }}>
                {STATS[0].value}
              </div>
              <div className="mb-6 text-lg font-bold" style={{ fontFamily: 'var(--font-display)' }}>
                {STATS[0].label}
              </div>
              <div className="grid grid-cols-2 gap-4">
                {STATS.slice(1).map(({ value, label }) => (
                  <div key={label} className="p-4 glass">
                    <div className="text-2xl font-black" style={{ fontFamily: 'var(--font-display)', color: 'var(--acid)' }}>
                      {value}
                    </div>
